...
describe('Successful - find the appropriate course', function () {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('TC-007-001', async function () {
    ...
    {
      const element = await driver.findElement(By.css("#groupingdropdown > span"))
...
describe('Successful - find another appropriate course ', function () {
  this.timeout(30000)
  let driver
  let vars
  beforeEach(async function () {
...
describe("Successful - Cancel find course process", function () {
  this.timeout(30000);
  let driver;
  let vars;
  beforeEach(async function () {
